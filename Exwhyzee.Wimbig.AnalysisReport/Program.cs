...
namespace Exwhyzee.Wimbig.AnalysisReport
{
    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            ServiceRunner<AnalysisReport>.Run(config =>
            {
                ...
                config.Service(serviceConfig =>
                {
                    ...
                    {
                        return new AnalysisReport(controller, roleManager, purchaseTicketAppService, countAppService, payOutReportsAppService, userManger);
                    });
