...
CREATE PROCEDURE [dbo].[spRaffleBySortOrder]
@status int = null,
...
AS
	...
	SELECT [Raffle].Id AS Id, [Name],[Description],NumberOfTickets,PricePerTicket,DeliveryType,HostedBy,StartDate, EndDate,[Status],DateCreated,TotalSold, [Raffle].SortOrder, [Raffle].Location, [Raffle].AreaInCity,
