...
CREATE PROCEDURE [dbo].[spTransactionsReadAll]
...
AS
	...
	SELECT [Transactions].Id AS Id, [Transactions].WalletdId,[Transactions].Amount,[Transactions].DateOfTransaction,[Transactions].TransactionReference,[Transactions].Status,[Transactions].TransactionType, [Transactions].Description, [Transactions].UserId, [Transactions].Sender,
