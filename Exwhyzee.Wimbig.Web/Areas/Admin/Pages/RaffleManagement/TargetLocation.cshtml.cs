...
namespace Exwhyzee.Wimbig.Web.Areas.Admin.Pages.RaffleManagement
{
    ...
    public class TargetLocationModel : PageModel
    {
        private readonly IRaffleAppService _raffleAppService;

        public TargetLocationModel(IRaffleAppService raffleAppService)
        {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            var paggedSource = paggedRaffles.Source.Where(x => x.Location != null).ToList();
