...
namespace Exwhyzee.Wimbig.Web.Areas.Admin.Pages.RaffleManagement
{
    ...
    public class DrawnModel : PageModel
    {
        private readonly IRaffleAppService _raffleAppService;

        public DrawnModel(IRaffleAppService raffleAppService)
        {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            var paggedSource = paggedRaffles.Source.Where(x=>x.Status == Enums.EntityStatus.Drawn).ToList();
