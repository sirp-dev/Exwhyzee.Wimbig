...
{
    [AllowAnonymous]
    public class ResendCodeModel : PageModel
    {
        ...
        public ResendCodeModel(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager,
        ...
        public async Task<IActionResult> OnGetAsync(string id)
        {
            ...
            return RedirectToPage("./Verify", new { id = user.Id });
