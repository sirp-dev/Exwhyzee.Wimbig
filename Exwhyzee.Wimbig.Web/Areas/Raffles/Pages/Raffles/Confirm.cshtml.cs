...
namespace Exwhyzee.Wimbig.Web.Areas.Raffles.Pages.Raffles
{
    public class ConfirmModel : PageModel
    {
        ...
        public ConfirmModel(IPurchaseTicketAppService purchaseTicketAppService,
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            try
            {
                ...
                //var count = check.Source.Where(x => x.PhoneNumber == user.PhoneNumber).Count();
                //if (count >= 5)
                //{
                //    TempData["checkaffle"] = "You can not play morethan 5 ticket in a Raffle. you have " + (3 - count) + " chance remaining";

                //    return RedirectToPage("./Confirm", new { id = Raffle.Id });
