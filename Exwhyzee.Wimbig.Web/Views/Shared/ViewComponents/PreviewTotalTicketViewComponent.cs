...
{
    public class PreviewTotalTicketViewComponent : ViewComponent
    {
        ...
        public PreviewTotalTicketViewComponent(UserManager<ApplicationUser> userManager
, IHostingEnvironment hostingEnv, IPurchaseTicketAppService purchaseTicketAppService)
        ...
        private async Task<int> GetWinnerAsync(string id)
        {
            int count = 0;
            try
            {
