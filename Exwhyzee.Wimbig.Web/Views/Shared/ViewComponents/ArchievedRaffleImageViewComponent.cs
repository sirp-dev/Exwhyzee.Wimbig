...
{
    public class ArchievedRaffleImageViewComponent : ViewComponent
    {
        ...
        public ArchievedRaffleImageViewComponent(IMapImageToRaffleAppService mapImageToRaffleAppService, IHostingEnvironment hostingEnv, IPurchaseTicketAppService purchaseTicketAppService)
        {
