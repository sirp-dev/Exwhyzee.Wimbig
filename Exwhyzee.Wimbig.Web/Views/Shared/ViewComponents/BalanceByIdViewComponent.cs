...
{
    public class BalanceByIdViewComponent : ViewComponent
    {
        private readonly IWalletAppService _walletAppService;
        private readonly UserManager<ApplicationUser> _userManager;

        public BalanceByIdViewComponent(
        ...
        private async Task<WalletDto> GetBalAsync(string id)
        {
