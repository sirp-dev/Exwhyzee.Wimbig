...
import { DragAndDropLayout4Module } from '../../components/list-view/drag-and-drop/layout-4/drag-and-drop-layout-4.module';
...
@NgModule({
  ...
  imports: [
    ...
    DragAndDropLayout1Module, DragAndDropLayout2Module,
    DragAndDropLayout3Module, DragAndDropLayout4Module
  ],
