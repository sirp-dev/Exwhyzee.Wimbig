...
import { GoogleCardLayout4Module } from '../../components/list-view/google-card/layout-4/google-card-layout-4.module';
...
@NgModule({
  ...
  imports: [
    ...
    GoogleCardLayout3Module, GoogleCardLayout4Module
  ],
