...
import { SwipeToDismissLayout4Module } from '../../components/list-view/swipe-to-dismiss/layout-4/swipe-to-dismiss-layout-4.module';
...
@NgModule({
  ...
  imports: [
    ...
    SwipeToDismissLayout3Module, SwipeToDismissLayout4Module
  ],
